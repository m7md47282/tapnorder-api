  ...
  template: `
    <div class="min-h-screen bg-background">
      <header class="border-b">
        <div class="container mx-auto px-4 py-6">
          <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-primary">Kitchen Dashboard</h1>
      ...
      <main class="container mx-auto px-4 py-8">
        <app-card>
          <app-card-header>
            <app-card-title>Kitchen Operations</app-card-title>
          </app-card-header>
          <app-card-content>
            <div class="text-center py-8">
              <p class="text-muted-foreground">Kitchen dashboard functionality will be implemented here</p>
            </div>
          </app-card-content>
        </app-card>
      </main>
